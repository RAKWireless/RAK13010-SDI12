...
/*
 * Using DWT instead of micros, the delay of micros is not accurate, 
 * which will cause the phenomenon of inaccurate and garbled baud rate.
 */
  sdi12timer_t us_timestamp ;

  //us_timestamp = ((sdi12timer_t)(micros() >> 6)) / 64;

  us_timestamp = (DWT->CYCCNT / 64) / 64; // 
